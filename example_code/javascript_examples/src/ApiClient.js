...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CiscoPsirtOpenVulnApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.cisco.com
     */
    this.basePath = 'https://api.cisco.com'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'psirt_openvuln_api_auth': {type: 'oauth2'}
    };
    /**
